...
//
// Components:
//   - I: The logging level (Info in this case). Other built-in values are D for
//     Debug, W for Warning, E for Error, and F for Fatal.
...
//   - filename.go: The basename of the file that logged the message.
...
//
//	flag.IntVar(&ln.Verbosity, "v", ln.Verbosity, "Logging verbosity.")
//
...
//	ln.Fatal = ln.MakeLogger("F", ln.PrintWriter{t.Fatal}, ln.Terminate)
package ln
